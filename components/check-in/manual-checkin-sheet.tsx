...
import ManualCheckInForm from '@/components/check-in/manual-checkin-form'

const ManualCheckInSheet = () => {
    const { isOpen, onClose } = manualCheckInSheet()
    return (
        <Sheet open={isOpen} onOpenChange={onClose}>
            <SheetContent className='flex rounded-tl-2xl rounded-bl-2xl overflow-y-auto flex-col gap-5 xl:w-[45%] p-0 xl:max-w-none sm:min-w-[540px] bg-[linear-gradient(to_bottom,#DEE1E6FF,#E4E7DFFF)]'>
                <SheetTitle className='pt-7 px-12'>
                    <p className='text-[20px] leading-[30px] font-bold text-[#104263FF]'>Manual Check-in</p>
                </SheetTitle>
...
export default ManualCheckInSheet